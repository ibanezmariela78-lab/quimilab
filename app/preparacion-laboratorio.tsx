...
export default function PreparacionLaboratorioScreen() {
  ...
  const basePlan = useMemo(() => {
    ...
    return createLabPreparationPlan({
      ...
      viscousKind:
        automaticPreparation.type === "viscousPreparation"
          ? automaticPreparation.viscousKind
          : undefined,
    });
  }, [
    objective,
    ...
    <>
      ...
      >
        ...
        <Text style={styles.subtitle}>
          Ingresá los componentes. QuimiLab analiza las sustancias, determina
          el tipo de preparación y selecciona los cálculos y materiales
          adecuados.
        </Text>
            ...
            {isLiquidLiquid ? (
              pairInteraction ? (
                ...
                <Text style={styles.body}>
                  QuimiLab todavía no dispone de información específica sobre
                  la interacción entre estos líquidos.
                </Text>
              )
                  ...
                  <>
                    ...
                    {traceMode === "dilute-aqueous" ? (
                      ...
                      <>
                        ...
                        <Text style={styles.helper}>
                          Esta opción calcula ppm o ppb directamente respecto
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.body}>
            ...
            concentración y el nivel de seguridad antes de generar los
            cálculos, materiales y procedimiento.
          </Text>
        </View>
      </ScrollView>
    </>
    ...
    <>
      ...
      <View style={styles.helperBox}>
        <Text style={styles.body}>
          ...
          instrumental. Si no pueden medirse con precisión, corresponde
          preparar una solución madre y luego realizar una dilución.
        </Text>
      </View>
    </>
  );
    ...
    <>
      ...
      <View style={styles.helperBox}>
        <Text style={styles.body}>
          ...
          final menos volumen del componente, porque los volúmenes pueden no
          ser perfectamente aditivos.
        </Text>
      </View>
    </>
  );
